...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://player.vidsrc.nl/embed/{tv/movie}/{id}?server=telugu" width="100%" height="100% loading="lazy" frameborder="0" allowfullscreen></iframe>`;
};
