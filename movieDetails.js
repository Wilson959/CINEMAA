...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://playerx-stream.blogspot.com/${id}" width="100%" height="100%" scrolling="no" loading="lazy" frameborder="0" allowfullscreen></iframe>`;
};
